...
extern "C" {
    #[link_name = "wolfSSL_BIO_set_flags"]
    pub fn BIO_set_flags(b: *mut BIO, flags: c_int);
    #[link_name = "wolfSSL_BIO_clear_flags"]
...
extern "C" {
    ...
    #[link_name = "wolfSSL_BIO_new_socket"]
    pub fn BIO_new_socket(sock: c_int, close_flag: c_int) -> *mut BIO;

    #[cfg(any(ossl110, libressl273))]
    #[link_name = "wolfSSL_BIO_meth_new"]
    pub fn BIO_meth_new(type_: c_int, name: *const c_char) -> *mut BIO_METHOD;
    #[cfg(any(ossl110, libressl273))]
    #[link_name = "wolfSSL_BIO_meth_free"]
